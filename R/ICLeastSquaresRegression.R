...
#' @param lambda1 <what param does>
#' @param lambda2 <what param does>
#' @param scale <what param does>
#' @param lowerbound <what param does>
#' @param upperbound <what param does>
#' @param ... <what param does>
#' @param method <what param does>
#' @export
ICLeastSquaresRegression <- function(X, y, X_u, lambda1=0, lambda2=0, scale=FALSE,lowerbound=-Inf, upperbound=Inf,...,method="default") {

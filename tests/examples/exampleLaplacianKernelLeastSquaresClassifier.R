...
g_sup <- KernelLeastSquaresClassifier(dmat, tvec, kernel=rbfdot(10), lambda=0.001, scale = TRUE)
g_kernel<- LaplacianKernelLeastSquaresClassifier(X=dmat, y=tvec, X_u=dmatU, kernel=rbfdot(10), lambda=0.001, gamma=500, adjacency_kernel = rbfdot(10), scale = TRUE)
